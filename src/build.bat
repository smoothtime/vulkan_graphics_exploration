@echo off
set CommonCompilerFlags=-MT -nologo /I ..\src\platform /I %VULKAN_SDK%\Include -fp:fast -Gm- -EHa- -GR- -Od -Oi -WX -W4 -wd4100 -wd4189 -wd4201 -wd4244 -wd4577 -wd4505 -wd4127 -wd4530 -FC -Z7 
